...
public class CrawlingPropertyTagResDto {
	...
	public static CrawlingPropertyTagResDto fromEntity(CrawlingProperty crawlingProperty,
		Map<String, List<Tag>> propertyTagsMap) {
	...
	public static CrawlingPropertyTagResDto fromEntity(CrawlingProperty crawlingProperty) {
		return CrawlingPropertyTagResDto.builder()
			...
			.realEstateOfficeAddress(crawlingProperty.getRealEstateOfficeAddress())
			.tags(
				crawlingProperty.getCrawlingPropertyTagMaps()
					.stream()
					.map(tagEntity -> Tag.builder()
						.tagId(tagEntity.getTag().getTagId())
						.type(tagEntity.getTag().getType())
						.value(tagEntity.getTag().getValue())
						.build())
					.toList()
			)
			.build();
