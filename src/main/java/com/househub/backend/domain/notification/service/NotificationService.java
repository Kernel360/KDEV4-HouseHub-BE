...
public class NotificationService {
	...
	public List<NotificationDto> getUnreadNotifications(AgentResDto agentDto) {
		List<Notification> unreadNotifications = notificationReader.findUnreadNotifications(agentDto.getId());
		return unreadNotifications.stream()
